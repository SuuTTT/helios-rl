...
def main():
    ...
    SEED            = 42
    N_ENVS          = 1024        # parallel JAX envs → ~82k env-sps in env alone
    TOTAL_ENV       = 10_000_000  # total env-steps; ~10 min at projected sps
    WARMUP_ENV      = 25_000      # env-steps before training
    BS              = 256
    SEQ             = 6
    K_UPDATE        = 64          # gradient steps per global step; UTD=64/1024=1/16
    LR              = 3e-4
    LATENT          = 128
